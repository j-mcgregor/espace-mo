            ...
            <main className="mt-10">
                ...
                <div className="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed">
                    <p className="pb-6">
                        ...
                        an. She projection advantages resolution son indulgence. Part sure on no long life am at
                    ...
                    <p className="pb-6">
                        ...
                        surrounded prosperous stimulated am me discretion expression. But truth being state can she
                        china widow. Occasional preference fat remarkably now projecting uncommonly dissimilar.
                        Sentiments projection particular companions interested do at my delightful. Listening
                    ...
                    <div className="border-l-4 border-gray-500 pl-4 mb-6 italic rounded">
                        ...
                        seeing latter he should thirty whence. Steepest speaking up attended it as. Made neat an on
                    ...
                    <p className="pb-6">
                        Detract yet delight written farther his general. If in so bred at dare rose lose good. Feel
                        and make two real miss use easy. Celebrated delightful an especially increasing instrument
                        am. Indulgence contrasted sufficient to unpleasant in in insensible favourable. Latter
                        remark hunted enough vulgar say man. Sitting hearted on it without me.
                    </p>
                </div>
            </main>
        </div>
